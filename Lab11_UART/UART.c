...
// declare global variable to hold the string
char String[10];
...
// as part of Lab 11 implement this function
	int i=0;
	//while ((UART0_FR_R&0x0020)!=0); // wait till TxFF is 0
	//for (i=0;i<sizeof(buffer[i]);i++){ 
  while (buffer[i]!= '\0'){	// write until the ned of the string
		UART_OutChar(buffer[i]);
		i++;
		//Delay1ms(8); 	// delay of 8 ms
	}
}
...
// as part of Lab 11 implement this function
	if (n < 10){
		...
		String[1] = n/100 + 0x30;	// get to the hundred digit
		n= n % 100;
		String[2] = n/10 + 0x30;	// get to the tens digit
		n = n % 10;
		String[3] = n + 0x30;	// get the ones digit
	}
	else {
		String[0] = String[1] = String[2] = String[3] = '*';
	}
	String[4] = 0x20;  // put a space
	String [5] = 0x00;  // put null terminator
}
