...
void SetVT(void){
// write this function
	GPIO_PORTF_DATA_R |= 0x02;		//VT is PF1 -- bit 1 is high
}
...
void ClearVT(void){
// write this function
	GPIO_PORTF_DATA_R &= ~0x02;		// bit 1 of VT is low
}
...
void SetReady(void){
// write this function
	GPIO_PORTF_DATA_R |= 0x08;		// bit 1 of Ready is high
}
...
void ClearReady(void){
// write this function
	GPIO_PORTF_DATA_R &= ~0x08;		// bit 1 of Ready is low
}
